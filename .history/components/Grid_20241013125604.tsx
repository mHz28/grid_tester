...
const Grid: React.FC = () => {
  ...
  useEffect(() => {
    fetch("https://tsttmp.s3.us-west-2.amazonaws.com/large-file.json")
  ...
  const columnDefs: agGrid.ColDef[] = [
    ...
    { field: "actor", filter: "agSetColumnFilter" },
    { field: "payload", filter: "agSetColumnFilter" },
    { field: "repo", filter: "agSetColumnFilter" },
    { field: "public", filter: "agTextColumnFilter" },
